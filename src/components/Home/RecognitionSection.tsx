...
export default function RecognitionSection() {
	return (
		<section
			...
			className='p-5 xs:p-8 md:p-28 md:pt-16 bg-recognition-bg md:bg-cover bg-position-y-50 bg-no-repeat '>
			...
			<div className=' bg-white flex lg:justify-around flex-col lg:flex-row items-start md:items-center mt-12 justify-center border rounded-3xl py-4 md:py-6 max-w-[1240px]'>
				<div className='flex flex-col col-span-1 pb-8 px-4 md:py-6 lg:py-0'>
					<img
						src={web3Grant}
						className='w-[286px] h-[143px]'
					/>
					...
					<div className='flex flex-col justify-between'>
						...
						<p className='mt-1 text-base overflow-hidden ellipsis md:min-h-[140px] md:max-w-[286px] text-[#424242] leading-[20px]'>
				...
				<div className='flex flex-col col-span-1 mt-4 md:mt-0 pb-8 px-4 md:py-6 lg:py-0'>
					<img
