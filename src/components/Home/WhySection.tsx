...
export default function WhySection() {
	return (
		<section
			...
			<div className='container mx-4 xs:mx-12 md:mx-24 2xl:mx-48 mb-24 grid xl:grid-cols-2 justify-center items-center w-fit mt-8 md:mt-8 2xl:mt-12 gap-4 max-w-[1240px] lg:mx-auto'>
				{data.map(item => (
					<div
						key={item.id}
