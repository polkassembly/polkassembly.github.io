...
const GovernSection = () => {
  return (
    <section id='govern-section' className='flex flex-col items-center'>
      <div className='w-full border-t-8 border-pa-pink md:mb-8' />
      <div className=' w-full h-16 md:h-32 md:my-0 flex flex-col antialiased dark:bg-grid-white/[0.05] items-center justify-center relative overflow-hidden'>
        <InfiniteMovingCards my-5
          items={[
            { title: 'Govern' },
            { title: 'Participate' },
            { title: 'Collaborate' },
      ...
      <div className='flex w-full items-center gap-4  md:mt-0'>
