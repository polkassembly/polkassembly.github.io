...
export default function ProjectsSection() {
  const cards = data.map((card, index) => (
    ...
    >
      <div
        className={`'text-2xl h-[24px] ${
          card.title === "Polkassembly" && "-mt-4 -ml-2"
      ...
      <a href={card.link} target="_blank" rel="noopener noreferrer">
        <h1 className="text-base font-semibold md:text-xl text-black flex items-center gap-2">
          <img src={learnMore} alt="Learn More" className="w-8 h-8" />
          Learn More
        </h1>
      </a>
    </div>
  ...
  return (
    <>
      <section
        id="projects-section"
        className="flex flex-col lg:flex-row lg:items-center md:gap-10 justify-between pt-20 lg:my-[40px] 3xl:my-[60px] 5xl:my-[84px] lg:ml-28"
      >
...
const data = [
  {
    ...
    content:
      "One stop destination for on- chain and off-chain decision-making, treasury management, and fostering a thriving Web3 ecosystem. ",
  },
  {
    title: "Polkasafe",
    logo: polkasafeLogo,
    ...
    content:
      "Experience a new era of asset management with PolkaSafe. An all-improved MultiSig experience on the Polkadot Blockchain.",
  },
  {
    title: "Polkassembly",
