    ...
    >
      <div className="relative w-full">
          ...
          <div
            className={cn(
              `flex flex-row justify-start ${
                type === "news" ? "md:gap-12" : "gap-4 md:gap-12"
              } `,
              "mx-auto"
            )}
          >
        ...
        <div className="flex justify-end gap-2 mr-10">
          {type === "news" ? (
            <button
              className={`absolute -translate-y-1/2 z-40 bottom-12  ${
                !isMobile() ? " md:-left-16 top-1/2  " : "-left-5 top-2/3 "
            ...
            <button
              className={`absolute top-1/2 -translate-y-1/2 ${
                !isMobile() ? "-left-2 md:left-8 " : "-left-2  "
              } z-40 h-14 w-14 rounded-full flex items-center justify-center`}
              onClick={scrollLeft}
              disabled={!canScrollLeft}
            >
              <div
                className={`w-8 h-8 md:w-14 md:h-14 rotate-180 rounded-full bg-slate-800 flex items-center justify-center ${
            ...
            {type === "news" ? (
              <button
                className={`absolute  -translate-y-1/2 ${
                  !isMobile()
                    ? "-right-0 lg:-right-16 top-1/2"
                    : "-right-4 top-2/3"
                } bottom-12 z-40 h-14 w-14 rounded-full flex items-center justify-center`}
                onClick={scrollRight}
              ...
              >
                <div
                  className={`w-8 h-8 md:w-14 md:h-14 rounded-full bg-slate-800 flex items-center justify-center ${
