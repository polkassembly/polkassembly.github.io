		...
		<Component
			...
			<div
				...
				<MovingBorder
					...
					rx='30%'
					ry='30%'>
					<div className={cn('h-20 w-20 opacity-[0.8] bg-[radial-gradient(#E80B81_60%,transparent_60%)]', borderClassName)} />
				</MovingBorder>
			</div>

			<div
				className={cn('relative backdrop-blur-xl text-white w-full h-full text-sm p-8', className)}
				style={{
