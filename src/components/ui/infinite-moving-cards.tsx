            ...
            >
              {item.title && (
                ...
                >
                  ...
                  <h3
                    className={`mt-3 md:mt-5 text-base font-medium md:text-lg md:font-semibold text-black ${
    ...
    return (
      ...
      >
        <ul
          ref={scrollerRef}
          className={cn(
            'flex min-w-full shrink-0 gap-6 md:gap-24 py-4 w-max flex-nowrap',
            start && 'animate-scroll',
            pauseOnHover && 'hover:[animation-play-state:paused]'
          )}
        >
          {items.map((item, idx) => (
            <li className='flex items-center md:gap-4' key={item.title}>
